<div class="works index">
	...
	<tr>
		...
		<td><?php echo h($work['Work']['company_name']); ?>&nbsp;</td>
		<td><?php echo h($work['Work']['designation']); ?>&nbsp;</td>
		<td><?php echo h($work['Work']['info']); ?>&nbsp;</td>
		<td><?php echo h($work['Work']['start']); ?>&nbsp;</td>
		<td><?php echo h($work['Work']['end']); ?>&nbsp;</td>
